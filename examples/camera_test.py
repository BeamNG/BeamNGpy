...
from beamngpy.auto_camera import Auto_Camera
...
cam1 = Auto_Camera('camera1', bng, vehicle, is_using_shared_memory=True, pos=(-5, 0, 1), dir=(1, 0, 0), field_of_view=(70, 70), 
    near_far_planes=(0.1, 1000), render_size=(512, 512))
...
cam2 = Auto_Camera('camera2', bng, vehicle, is_using_shared_memory=False, pos=(5, 0, 1), dir=(-1, 0, 0), field_of_view=(70, 70), 
    near_far_planes=(0.1, 1000), render_size=(512, 512))

# Create a camera sensor which has an oblique angle to the world
cam3 = Auto_Camera('camera3', bng, vehicle, is_using_shared_memory=False, pos=(0, 5, 1), dir=(0, -1, 0), up=(1, 0, 1), field_of_view=(70, 70), 
    near_far_planes=(0.1, 1000), render_size=(512, 512))
...
idle_cam = Auto_Camera('idle cam', bng, vehicle, requested_update_time=-1.0, is_using_shared_memory=True, pos=(-5, 0, 1), dir=(1, 0, 0), 
