...
def main():
    ...
    vehicle1.acc.start(3.0, True) # ego vehicle should have ACC

    sleep(3.0)
    listrelDistX, listrelDistY, listrelVelX, listrelVelY, listrelAccX, listrelAccY, listtime, vel_ego, time_ego = [], [], [], [], [], [], [], [], []
