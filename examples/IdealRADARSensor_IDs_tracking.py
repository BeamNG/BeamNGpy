...
def main():
    ...
    vehicleC = Vehicle('other_vehicle2', model='etki', licence='vehicleC', color='Green')
    vehicleD = Vehicle('other_vehicle3', model='etki', licence='vehicleD', color='Black')
    # Create a scenario.
    ...
    idealRADAR1 = IdealRadar('idealRADAR1', bng, vehicleA, is_send_immediately=False, physics_update_time=0.01)
    ...
    ax[0].set(xlabel='time (s)', ylabel='ID of 1st vehicle', title='1st closest vehicle')
    ...
    ax[1].set(xlabel='time (s)', ylabel='ID of 2nd vehicle', title='2nd closest vehicle')
    ...
    ax[2].set(xlabel='time (s)', ylabel='ID of 3nd vehicle', title='3rd closest vehicle')
