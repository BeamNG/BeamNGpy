...
def test_safe_spawn_vehicle_spawn(beamng: BeamNGpy):
    ...
    with beamng as bng:
        for i, test_case in enumerate(test_cases):
            ...
            assert test_case['expected_z_range'][0] <= vehicle.sensors["state"]["pos"][2] <= test_case['expected_z_range'][1]
