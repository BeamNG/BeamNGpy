...
def test_lidar(beamng: BeamNGpy):
    with beamng as bng:
        ...
        print('Is ad-hoc request complete? ', lidar1.is_ad_hoc_poll_request_ready(request_id))
        ...
        sleep(3)
        # Ensure that the data has been processed before collecting.
        print('Is ad-hoc request 1 complete? ', lidar2.is_ad_hoc_poll_request_ready(request_id))
        # Collect the data now that it has been computed.
