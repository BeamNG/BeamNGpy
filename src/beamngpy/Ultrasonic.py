...
class Ultrasonic:
    ...
    def __init__(self, name, bng, vehicle=None, requested_update_time=0.1, update_priority=0.0, pos=(0, 0, 1.7), dir=(0, -1, 0), up=(0, 0, 1), size=(200, 200),
        ...
        bng.open_ultrasonic(name, vehicle, requested_update_time, update_priority, pos, dir, up, size, field_of_view, near_far_planes, range_roundess,
