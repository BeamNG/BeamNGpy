...
class AutoCamera:
    def __init__(
            ...
            dir=(0, -1, 0), up=(0, 0, 1), render_size=(200, 200), field_of_view=(10, 10), near_far_planes=(0.05, 100.0),
            is_using_shared_memory=True, is_render_colours=True, is_render_annotations=True, is_render_depth=True,
            use_instance_annotations=True, is_depth_inverted=False, is_visualised=True, is_static=False,
        ...
        bng.open_auto_camera(
            name, vehicle, requested_update_time, update_priority, self.render_size, field_of_view, near_far_planes,
            pos, dir, up, is_using_shared_memory, self.colour_handle, buffer_size, self.annotation_handle, buffer_size,
            self.depth_handle, buffer_size, is_render_colours, is_render_annotations, is_render_depth,
            use_instance_annotations, is_visualised, is_static, is_snapping_desired, is_force_inside_triangle)
    ...
    def poll(self):
        ...
        raw_readings = self.bng.poll_auto_camera(
            self.name, self.is_using_shared_memory, self.use_instance_annotations)['data']
