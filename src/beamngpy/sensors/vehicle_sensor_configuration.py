            ...
            if t == "camera":
                self.sensors.append(
                    Camera(
                        ...
                        is_streaming=False,
                        is_render_colours=v["renderColours"],
                        is_render_annotations=v["renderAnnotations"],
                        is_render_instance=v["renderInstance"],
                        is_render_depth=v["renderDepth"],
                ...
                self.sensors.append(
                    AdvancedIMU(
                        ...
                        dir=(v["dir"]["x"], v["dir"]["y"], v["dir"]["z"]),
                        up=(v["up"]["x"], v["up"]["y"], v["up"]["z"]),
                        smoother_strength=v["smootherStrength"],
